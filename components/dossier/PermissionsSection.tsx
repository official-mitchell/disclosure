  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="document-font font-bold text-base sm:text-lg"
          style={{
            color: "#3d2820",
      ...
      <div style={{ marginBottom: "clamp(1.5rem, 4vw, 2.5rem)" }}>
        ...
        <div
          className="border-2 border-green-700 bg-green-50/30 rounded"
      ...
      {restrictions.length > 0 && (
        <div>
          ...
          <div
            className="border-2 border-yellow-700 bg-yellow-50/30 rounded"
            style={{ padding: "clamp(0.75rem, 2vw, 1rem)" }}
          >
            <ul
              style={{
